...
CREATE TABLE dbo.CL_TMP_EXEMPT_CREDIT_LIMIT ( 
	...
	CONSTRAINT PK_CL_TMP_EXEMPT_CREDIT_LIMIT PRIMARY KEY CLUSTERED(TMP_ID)
...
ON [default] 
GO
CREATE NONCLUSTERED INDEX IND_CL_TMP_EXEMPT_CREDIT_LIMIT_WORK_ORDER_ID
	ON dbo.CL_TMP_EXEMPT_CREDIT_LIMIT(WORK_ORDER_ID)
	ON [default]
GO

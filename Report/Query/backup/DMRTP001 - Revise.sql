...
J.JOB_ASSIGN_DATE --สำหรับเป็น input ใน detail
...
AND G.AGENT_CODE ||'|'|| R.REGION_CODE = 'TEST TEST|LE' -- Criteria จากหน้าจอ เช่น ARN|CB, SWP|CW, ANP|SU (ไม่แน่ใจว่าจากหน้าจอจะ Concate String ส่งค่ามาแบบนี้หรือไม่ )
...
AND DATEADD(DAY, -8, getdate()) BETWEEN IB.BALANCE_START_DATE AND ISNULL(IB.BALANCE_END_DATE, CURRENT_DATE())  /*Invoice ที่มีหนี้ค้างชำระอยู่ ณ วันที่ Assign*/

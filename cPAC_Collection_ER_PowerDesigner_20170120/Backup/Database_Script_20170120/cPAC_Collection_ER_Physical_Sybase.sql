...
if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('CL_BA_INFO'))
            where name = 'FK_RELATIONSHIP_497' and type = 'RI')
   alter table CL_BA_INFO
      drop constraint FK_RELATIONSHIP_497
go
...
if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('CL_BA_INFO'))
            where name = 'FK_RELATIONSHIP_631' and type = 'RI')
   alter table CL_BA_INFO
      drop constraint FK_RELATIONSHIP_631
go
...
if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('CL_CA_INFO'))
            where name = 'FK_RELATIONSHIP_630' and type = 'RI')
   alter table CL_CA_INFO
      drop constraint FK_RELATIONSHIP_630
go
...
if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('CL_EXEMPT'))
            where name = 'FK_RELATIONSHIP_634' and type = 'RI')
   alter table CL_EXEMPT
      drop constraint FK_RELATIONSHIP_634
go

if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('CL_EXEMPT'))
            where name = 'FK_RELATIONSHIP_635' and type = 'RI')
   alter table CL_EXEMPT
      drop constraint FK_RELATIONSHIP_635
go

if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('CL_EXEMPT'))
            where name = 'FK_RELATIONSHIP_636' and type = 'RI')
   alter table CL_EXEMPT
      drop constraint FK_RELATIONSHIP_636
go
...
if exists (select 1 
            ...
            where name = 'FK_RELATIONSHIP_432' and type = 'RI')
   alter table CL_EXEMPT_ROLE
      drop constraint FK_RELATIONSHIP_432
go
...
if exists (select 1 
            ...
            where name = 'FK_RELATIONSHIP_409' and type = 'RI')
   alter table CL_HIS_BA_ACCOUNT_BALANCE
      drop constraint FK_RELATIONSHIP_409
go
...
if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('CL_HIS_BA_ACCOUNT_BALANCE'))
            where name = 'FK_RELATIONSHIP_479' and type = 'RI')
   alter table CL_HIS_BA_ACCOUNT_BALANCE
      drop constraint FK_RELATIONSHIP_479
go

if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('CL_HIS_BA_ACCOUNT_BALANCE'))
            where name = 'FK_RELATIONSHIP_480' and type = 'RI')
   alter table CL_HIS_BA_ACCOUNT_BALANCE
      drop constraint FK_RELATIONSHIP_480
go

if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('CL_HIS_BA_ACCOUNT_BALANCE'))
            where name = 'FK_RELATIONSHIP_481' and type = 'RI')
   alter table CL_HIS_BA_ACCOUNT_BALANCE
      drop constraint FK_RELATIONSHIP_481
go
...
if exists (select 1 
            ...
            where name = 'FK_RELATIONSHIP_387' and type = 'RI')
   alter table CL_HIS_BA_INVOICE_BALANCE
      drop constraint FK_RELATIONSHIP_387
go
...
if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('CL_HIS_BA_INVOICE_BALANCE'))
            where name = 'FK_RELATIONSHIP_436' and type = 'RI')
   alter table CL_HIS_BA_INVOICE_BALANCE
      drop constraint FK_RELATIONSHIP_436
go
...
if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('CL_HIS_BA_STATUS'))
            where name = 'FK_RELATIONSHIP_498' and type = 'RI')
   alter table CL_HIS_BA_STATUS
      drop constraint FK_RELATIONSHIP_498
go
...
if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('CL_HIS_MOBILE_STATUS'))
            where name = 'FK_RELATIONSHIP_632' and type = 'RI')
   alter table CL_HIS_MOBILE_STATUS
      drop constraint FK_RELATIONSHIP_632
go

if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('CL_HIS_MOBILE_STATUS'))
            where name = 'FK_RELATIONSHIP_633' and type = 'RI')
   alter table CL_HIS_MOBILE_STATUS
      drop constraint FK_RELATIONSHIP_633
go
...
if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('CL_LEGAL_COMPLAINT'))
            where name = 'FK_RELATIONSHIP_637' and type = 'RI')
   alter table CL_LEGAL_COMPLAINT
      drop constraint FK_RELATIONSHIP_637
go
...
if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('CL_NEGO'))
            where name = 'FK_RELATIONSHIP_638' and type = 'RI')
   alter table CL_NEGO
      drop constraint FK_RELATIONSHIP_638
go
...
if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('CL_NEGO_INVOICE'))
            where name = 'FK_RELATIONSHIP_441' and type = 'RI')
   alter table CL_NEGO_INVOICE
      drop constraint FK_RELATIONSHIP_441
go
...
if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('CL_NEGO_POLICY_ROLE'))
            where name = 'FK_RELATIONSHIP_629' and type = 'RI')
   alter table CL_NEGO_POLICY_ROLE
      drop constraint FK_RELATIONSHIP_629
go
...
if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('CL_NEGO_RECEIPT'))
            where name = 'FK_RELATIONSHIP_642' and type = 'RI')
   alter table CL_NEGO_RECEIPT
      drop constraint FK_RELATIONSHIP_642
go
...
if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('CL_WAIVE'))
            where name = 'FK_RELATIONSHIP_595' and type = 'RI')
   alter table CL_WAIVE
      drop constraint FK_RELATIONSHIP_595
go

if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('CL_WAIVE'))
            where name = 'FK_RELATIONSHIP_608' and type = 'RI')
   alter table CL_WAIVE
      drop constraint FK_RELATIONSHIP_608
go

if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('CL_WAIVE'))
            where name = 'FK_RELATIONSHIP_609' and type = 'RI')
   alter table CL_WAIVE
      drop constraint FK_RELATIONSHIP_609
go
...
if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('PM_AR_MOVEMENT'))
            where name = 'FK_RELATIONSHIP_500' and type = 'RI')
   alter table PM_AR_MOVEMENT
      drop constraint FK_RELATIONSHIP_500
go

if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('PM_AR_MOVEMENT'))
            where name = 'FK_RELATIONSHIP_501' and type = 'RI')
   alter table PM_AR_MOVEMENT
      drop constraint FK_RELATIONSHIP_501
go

if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('PM_AR_MOVEMENT'))
            where name = 'FK_RELATIONSHIP_502' and type = 'RI')
   alter table PM_AR_MOVEMENT
      drop constraint FK_RELATIONSHIP_502
go

if exists (select 1 
            from  sysobjects c 
            join  sysconstraints s on (s.constrid = c.id and s.tableid = object_id('PM_INVOICE'))
            where name = 'FK_RELATIONSHIP_273' and type = 'RI')
   alter table PM_INVOICE
      drop constraint FK_RELATIONSHIP_273
go
...
if exists (select 1
            from  sysindexes
           where  id    = object_id('CL_BA_INFO')
            and   name  = 'RELATIONSHIP_497_FK'
            and   indid > 0
            and   indid < 255)
   drop index CL_BA_INFO.RELATIONSHIP_497_FK
go
...
if exists (select 1
           ...
           where  id    = object_id('CL_HIS_BA_STATUS')
            and   name  = 'RELATIONSHIP_498_FK'
            and   indid > 0
            and   indid < 255)
   drop index CL_HIS_BA_STATUS.RELATIONSHIP_498_FK
go
...
if exists (select 1
            from  sysobjects
            where id = object_id('CL_SFF_BA_STATUS')
            and   type = 'U')
   drop table CL_SFF_BA_STATUS
go
...
if exists (select 1
            from  sysindexes
           where  id    = object_id('CL_WAIVE')
            and   name  = 'RELATIONSHIP_609_FK'
            and   indid > 0
            and   indid < 255)
   drop index CL_WAIVE.RELATIONSHIP_609_FK
go
...
if exists (select 1
            from  sysobjects
            where id = object_id('PM_ADJ_DTL')
            and   type = 'U')
   drop table PM_ADJ_DTL
go

if exists (select 1
            from  sysindexes
           where  id    = object_id('PM_AR_MOVEMENT')
            and   name  = 'RELATIONSHIP_502_FK'
            and   indid > 0
            and   indid < 255)
   drop index PM_AR_MOVEMENT.RELATIONSHIP_502_FK
go

if exists (select 1
            from  sysindexes
           where  id    = object_id('PM_AR_MOVEMENT')
            and   name  = 'RELATIONSHIP_501_FK'
            and   indid > 0
            and   indid < 255)
   drop index PM_AR_MOVEMENT.RELATIONSHIP_501_FK
go

if exists (select 1
            from  sysindexes
           where  id    = object_id('PM_AR_MOVEMENT')
            and   name  = 'RELATIONSHIP_500_FK'
            and   indid > 0
            and   indid < 255)
   drop index PM_AR_MOVEMENT.RELATIONSHIP_500_FK
go
...
if exists (select 1
            ...
            where id = object_id('PM_AR_MOVEMENT')
            and   type = 'U')
   drop table PM_AR_MOVEMENT
go

if exists (select 1
            from  sysobjects
            where id = object_id('PM_BATCH_ADJ_DTL')
            and   type = 'U')
   drop table PM_BATCH_ADJ_DTL
go

if exists (select 1
            from  sysobjects
            where id = object_id('PM_COMPANY')
            and   type = 'U')
   drop table PM_COMPANY
go

if exists (select 1
            from  sysindexes
           where  id    = object_id('PM_INVOICE')
            and   name  = 'RELATIONSHIP_273_FK'
            and   indid > 0
            and   indid < 255)
   drop index PM_INVOICE.RELATIONSHIP_273_FK
go
...
if exists (select 1
            ...
            where id = object_id('PM_INVOICE')
            and   type = 'U')
   drop table PM_INVOICE
go

if exists (select 1
            from  sysobjects
            where id = object_id('PM_RECEIPT')
            and   type = 'U')
   drop table PM_RECEIPT
go

if exists (select 1
            from  sysobjects
            where id = object_id('PM_SUB_MODULE')
            and   type = 'U')
   drop table PM_SUB_MODULE
go

if exists (select 1
            from  sysobjects
            where id = object_id('PM_V_LOCATION')
            and   type = 'U')
   drop table PM_V_LOCATION
go

if exists (select 1
            from  sysobjects
            where id = object_id('SFF_ZIPCODE')
            and   type = 'U')
   drop table SFF_ZIPCODE
go
...
create table CL_AGENT_COMPANY (
   ...
   AGENT_COMPANY_NAME   varchar(100)                   not null,
   ...
   SAP_COMP_CODE        varchar(10)                    not null,
...
create table CL_BATCH_TYPE (
   ...
   BATCH_TYPE_NAME      varchar(100)                   not null,
   BATCH_TYPE_DESC      varchar(100)                   null,
...
create table CL_BA_INFO (
   ...
   BA_TITLE             varchar(50)                    not null,
   BA_NAME              varchar(200)                   not null,
   BA_STATUS            varchar(30)                    not null,
   BA_STATUS_DTM        datetime                       not null,
   ...
   BILL_ADDRESS_NAME    varchar(200)                   not null,
   BILL_ADDRESS_LINE_1  varchar(100)                   not null,
   BILL_ADDRESS_LINE_2  varchar(100)                   null,
   BILL_ADDRESS_LINE_3  varchar(100)                   null,
   BILL_ADDRESS_LINE_4  varchar(100)                   null,
   BILL_ADDRESS_LINE_5  varchar(100)                   null,
   BILL_ZIPCODE         varchar(10)                    not null,
   BILL_PROVINCE_ID     unsigned bigint                not null,
   BILL_REGION_ID       unsigned bigint                not null,
   ...
   SB_ACCOUNT_ID        varchar(50)                    not null,
   CREATED              datetime                       not null,
   CREATED_BY           varchar(50)                    not null,
   LAST_UPD             datetime                       null,
   LAST_UPD_BY          varchar(50)                    null,
...
/*==============================================================*/
/* Index: RELATIONSHIP_497_FK                                   */
/*==============================================================*/
create index RELATIONSHIP_497_FK on CL_BA_INFO (
BA_STATUS ASC
)
go
...
create table CL_BLACKLIST (
   ...
   BA_NO                varchar(30)                    not null,
   BLACKLIST_ACTION_ID  unsigned bigint                null,
   BLACKLIST_CRITERIA_ID unsigned bigint                null,
...
create table CL_CA_INFO (
   ...
   CA_STATUS_DTM        datetime                       not null,
   CATEGORY             varchar(50)                    not null,
   SUBCATEGORY          varchar(50)                    not null,
   REGISTER_DATE        date                           not null,
   REGISTER_LOCATION    unsigned bigint                null,
   ...
   VAT_ADDRESS_NAME     varchar(200)                   not null,
   VAT_ADDRESS_LINE_1   varchar(100)                   not null,
   VAT_ADDRESS_LINE_2   varchar(100)                   null,
   VAT_ADDRESS_LINE_3   varchar(100)                   null,
   VAT_ADDRESS_LINE_4   varchar(100)                   null,
   VAT_ADDRESS_LINE_5   varchar(100)                   null,
   VAT_ZIPCODE          varchar(10)                    not null,
   SFF_ACCOUNT_ID       varchar(50)                    not null,
   SB_ACCOUNT_ID        varchar(50)                    not null,
   CREATED              datetime                       not null,
   CREATED_BY           varchar(50)                    not null,
...
create table CL_CONTACT_ADDRESS (
   ...
   CONTACT_ADDR_LINE_1  varchar(100)                   not null,
...
create table CL_EXEMPT_ACTION (
   ...
   LAST_UPD             datetime                       null,
   LAST_UPD_BY          varchar(50)                    null,
   constraint PK_CL_EXEMPT_ACTION primary key (EXEMPT_PACK_ID, ACTION_ID)
)
go
...
create table CL_EXEMPT_AREA (
   ...
   LAST_UPD             datetime                       null,
   LAST_UPD_BY          varchar(50)                    null,
   constraint PK_CL_EXEMPT_AREA primary key (EXEMPT_ID, ACTION_ID)
)
go
...
create table CL_HIS_BA_PRIORITY_STATUS (
   ...
   BA_NO                varchar(30)                    not null,
   PRIORITY_STATUS_ID   unsigned bigint                not null,
   PRIORITY_STATUS_DATE date                           not null,
   RECORD_START_DTM     datetime                       not null,
   RECORD_END_DTM       datetime                       null,
   CURRENT_BOO          char(1)                       
       default 'Y' not null,
...
create table CL_HIS_BA_PRODUCT_GROUP (
   ...
   BA_NO                varchar(30)                    not null,
   PRODUCT_GROUP_ID     unsigned bigint                not null,
   RECORD_START_DTM     datetime                       not null,
   RECORD_END_DTM       datetime                       null,
   CURRENT_BOO          char(1)                       
       default 'Y' not null,
...
/*==============================================================*/
/* Index: RELATIONSHIP_498_FK                                   */
/*==============================================================*/
create index RELATIONSHIP_498_FK on CL_HIS_BA_STATUS (
BA_STATUS ASC
)
go
...
create table CL_HIS_MOBILE_STATUS (
   ...
   MOBILE_NO            varchar(30)                    not null,
   MOBILE_STATUS        varchar(30)                    not null,
   MOBILE_STATUS_REASON varchar(200)                   not null,
   STATUS_START_DTM     datetime                       not null,
   STATUS_END_DTM       datetime                       null,
   ...
   CREATED              datetime                       not null,
   CREATED_BY           varchar(50)                    not null,
   CREATED_POSITION     varchar(50)                    not null,
   CREATED_DIVISION     varchar(50)                    not null,
   CREATED_LOCATION     unsigned bigint                not null,
   LAST_UPD             datetime                       null,
   LAST_UPD_BY          varchar(50)                    null,
   LAST_UPD_POSITION    varchar(50)                    null,
   LAST_UPD_DIVISION    varchar(50)                    null,
...
create table CL_MEMO (
   ...
   MEMO_POSTSCRIPT      varchar(100)                   null,
...
create table CL_MEMO_TYPE (
   ...
   MEMO_TYPE_NAME       varchar(100)                   not null,
   ...
   MEMO_TYPE_POSTSCRIPT varchar(100)                   null,
...
create table CL_MOBILE_INFO (
   ...
   MOBILE_SEGMENT       varchar(50)                    not null,
   MOBILE_STATUS        varchar(30)                    not null,
   MOBILE_STATUS_REASON varchar(255)                   not null,
   ...
   CONTRACT_BOO         char(1)                        not null,
   CONTRACT_PHONE_BOO   char(1)                        not null,
...
create table CL_NEGO_POLICY (
   ...
   NEGO_POLICY_NAME     varchar(100)                   not null,
...
create table CL_ORDER (
   ...
   BA_NO                varchar(30)                    not null,
   MOBILE_NO            varchar(30)                    not null,
   ORDER_ACTION_ID      unsigned bigint                null,
...
create table CL_PROVINCE (
   ...
   REGION_ID            unsigned bigint                not null,
   SFF_PROVINCE_TH      varchar(50)                    null,
...
create table CL_REGION (
   ...
   CSO_REGION           varchar(50)                    not null,
   RECORD_ORDER         int                           
       default 0 not null,
   RECORD_STATUS        smallint                      
       default 1 not null,
...
/*==============================================================*/
/* Table: CL_SFF_BA_STATUS                                      */
/*==============================================================*/
create table CL_SFF_BA_STATUS (
   BA_STATUS            varchar(30)                    not null,
   BA_STATUS_DESC       varchar(100)                   not null,
   BA_STATUS_GROUP      smallint                       not null,
   SFF_CFG_LOV_ID       varchar(50)                    not null,
   RECORD_ORDER         int                           
       default 0 not null,
   RECORD_STATUS        smallint                      
   ...
   LAST_UPD             datetime                       null,
   LAST_UPD_BY          varchar(50)                    null,
   constraint PK_CL_SFF_BA_STATUS primary key (BA_STATUS)
)
with identity_gap = 10
go
...
create table CL_TEMPLATE (
   ...
   TEMPLATE_DESC        varchar(200)                   null,
...
create table CL_WAIVE (
   ...
   WAIVE_ACTION_ID      unsigned bigint                null,
   WAIVE_CRITERIA_ID    unsigned bigint                null,
   ...
   PM_BATCH_ADJ_DTL_ID  unsigned bigint                null,
   CREATED              datetime                       not null,
   CREATED_BY           varchar(50)                    not null,
   LAST_UPD             datetime                       null,
   LAST_UPD_BY          varchar(50)                    null,
...
/*==============================================================*/
/* Index: RELATIONSHIP_609_FK                                   */
/*==============================================================*/
create index RELATIONSHIP_609_FK on CL_WAIVE (
PM_BATCH_ADJ_DTL_ID ASC
)
go
...
create table CL_WAIVE_CRITERIA (
   ...
   ADJ_MAIN_CAUSE       varchar(100)                   not null,
   ADJ_SUB_CAUSE        varchar(100)                   not null,
   RECORD_START_DTM     datetime                       not null,
   RECORD_END_DTM       datetime                       null,
   CREATED              datetime                       not null,
   CREATED_BY           varchar(50)                    not null,
...
/* Table: PM_ADJ_DTL                                            */
/*==============================================================*/
create table PM_ADJ_DTL (
   REQ_DTL_ID           unsigned bigint                not null,
   constraint PK_PM_ADJ_DTL primary key (REQ_DTL_ID)
)
go

/*==============================================================*/
/* Table: PM_AR_MOVEMENT                                        */
/*==============================================================*/
create table PM_AR_MOVEMENT (
   AR_MOVEMENT_ID       unsigned bigint                not null,
   COMPANY_ID           unsigned bigint                not null,
   BA_NO                varchar(30)                    not null,
   REF_TRANS_TYPE       char(1)                        not null,
   REF_TRANS_ID         unsigned bigint                not null,
   MOVEMENT_SEQ         int                            not null,
   NON_VAT_AMT          decimal(14,2)                  null,
   NET_VAT_AMT          decimal(14,2)                  null,
   VAT_AMT              decimal(14,2)                  null,
   TOTAL_AMT            decimal(14,2)                  not null,
   NON_VAT_BAL          decimal(14,2)                  null,
   NET_VAT_BAL          decimal(14,2)                  null,
   VAT_BAL              decimal(14,2)                  null,
   MOVEMENT_TYPE        char(2)                        not null,
   MOVEMENT_FLG         char(2)                        not null,
   MOVEMENT_DATE        date                           not null,
   PROCESS_DTM          datetime                       not null,
   ...
   LAST_UPD_BY          varchar(50)                    null,
   LAST_UPD             datetime                       null,
   constraint PK_PM_AR_MOVEMENT primary key (AR_MOVEMENT_ID)
)
go

/*==============================================================*/
/* Index: RELATIONSHIP_500_FK                                   */
/*==============================================================*/
create index RELATIONSHIP_500_FK on PM_AR_MOVEMENT (
COMPANY_ID ASC
)
go

/*==============================================================*/
/* Index: RELATIONSHIP_501_FK                                   */
/*==============================================================*/
create index RELATIONSHIP_501_FK on PM_AR_MOVEMENT (
BA_NO ASC
)
go

/*==============================================================*/
/* Index: RELATIONSHIP_502_FK                                   */
/*==============================================================*/
create index RELATIONSHIP_502_FK on PM_AR_MOVEMENT (
REF_TRANS_ID ASC
)
go

/*==============================================================*/
/* Table: PM_BATCH_ADJ_DTL                                      */
/*==============================================================*/
create table PM_BATCH_ADJ_DTL (
   BATCH_DTL_ID         unsigned bigint                not null,
   constraint PK_PM_BATCH_ADJ_DTL primary key (BATCH_DTL_ID)
)
go
...
create table PM_COMPANY (
   ...
   constraint PK_PM_COMPANY primary key (COMPANY_ID)
)
go
...
create table PM_INVOICE (
   INVOICE_ID           unsigned bigint                not null,
   BA_NO                varchar(30)                    not null,
   constraint PK_PM_INVOICE primary key (INVOICE_ID)
)
go

/*==============================================================*/
/* Index: RELATIONSHIP_273_FK                                   */
/*==============================================================*/
create index RELATIONSHIP_273_FK on PM_INVOICE (
BA_NO ASC
)
go
...
/* Table: PM_RECEIPT                                            */
/*==============================================================*/
create table PM_RECEIPT (
   RECEIPT_ID           unsigned bigint                not null,
   constraint PK_PM_RECEIPT primary key (RECEIPT_ID)
)
go
...
/* Table: PM_SUB_MODULE                                         */
/*==============================================================*/
create table PM_SUB_MODULE (
   SUB_MODULE_ID        unsigned bigint                not null,
   constraint PK_PM_SUB_MODULE primary key (SUB_MODULE_ID)
)
go
...
/* Table: PM_V_LOCATION                                         */
/*==============================================================*/
create table PM_V_LOCATION (
   LOCATION_CODE        unsigned bigint                not null,
   constraint PK_PM_V_LOCATION primary key (LOCATION_CODE)
)
go
...
create table SFF_ZIPCODE (
   ...
   constraint PK_SFF_ZIPCODE primary key (ROW_ID)
)
go
...
alter table CL_BA_INFO
   add constraint FK_RELATIONSHIP_497 foreign key (BA_STATUS)
      references CL_SFF_BA_STATUS (BA_STATUS)
go
...
alter table CL_BA_INFO
   add constraint FK_RELATIONSHIP_631 foreign key (REGISTER_LOCATION)
      references PM_V_LOCATION (LOCATION_CODE)
go
...
alter table CL_CA_INFO
   add constraint FK_RELATIONSHIP_630 foreign key (REGISTER_LOCATION)
      references PM_V_LOCATION (LOCATION_CODE)
go
...
alter table CL_EXEMPT
   add constraint FK_RELATIONSHIP_634 foreign key (APPROVED_LOCATION)
      references PM_V_LOCATION (LOCATION_CODE)
go

alter table CL_EXEMPT
   add constraint FK_RELATIONSHIP_635 foreign key (CREATED_LOCATION)
      references PM_V_LOCATION (LOCATION_CODE)
go

alter table CL_EXEMPT
   add constraint FK_RELATIONSHIP_636 foreign key (LAST_UPD_LOCATION)
      references PM_V_LOCATION (LOCATION_CODE)
go
...
alter table CL_EXEMPT_ROLE
   add constraint FK_RELATIONSHIP_432 foreign key (SUB_MODULE_ID)
      references PM_SUB_MODULE (SUB_MODULE_ID)
go
...
alter table CL_HIS_BA_ACCOUNT_BALANCE
   add constraint FK_RELATIONSHIP_409 foreign key (AR_MOVEMENT_ID)
      references PM_AR_MOVEMENT (AR_MOVEMENT_ID)
go
...
alter table CL_HIS_BA_ACCOUNT_BALANCE
   add constraint FK_RELATIONSHIP_479 foreign key (MIN_INVOICE_ID)
      references PM_INVOICE (INVOICE_ID)
go

alter table CL_HIS_BA_ACCOUNT_BALANCE
   add constraint FK_RELATIONSHIP_480 foreign key (MAX_INVOICE_ID)
      references PM_INVOICE (INVOICE_ID)
go

alter table CL_HIS_BA_ACCOUNT_BALANCE
   add constraint FK_RELATIONSHIP_481 foreign key (MAX_RECEIPT_ID)
      references PM_RECEIPT (RECEIPT_ID)
go
...
alter table CL_HIS_BA_INVOICE_BALANCE
   add constraint FK_RELATIONSHIP_387 foreign key (AR_MOVEMENT_ID)
      references PM_AR_MOVEMENT (AR_MOVEMENT_ID)
go
...
alter table CL_HIS_BA_INVOICE_BALANCE
   add constraint FK_RELATIONSHIP_436 foreign key (INVOICE_ID)
      references PM_INVOICE (INVOICE_ID)
go
...
alter table CL_HIS_BA_STATUS
   add constraint FK_RELATIONSHIP_498 foreign key (BA_STATUS)
      references CL_SFF_BA_STATUS (BA_STATUS)
go
...
alter table CL_HIS_MOBILE_STATUS
   add constraint FK_RELATIONSHIP_632 foreign key (CREATED_LOCATION)
      references PM_V_LOCATION (LOCATION_CODE)
go

alter table CL_HIS_MOBILE_STATUS
   add constraint FK_RELATIONSHIP_633 foreign key (LAST_UPD_LOCATION)
      references PM_V_LOCATION (LOCATION_CODE)
go
...
alter table CL_LEGAL_COMPLAINT
   add constraint FK_RELATIONSHIP_637 foreign key (COMPLAINT_LOCATION)
      references PM_V_LOCATION (LOCATION_CODE)
go
...
alter table CL_NEGO
   add constraint FK_RELATIONSHIP_638 foreign key (NEGO_LOCATION)
      references PM_V_LOCATION (LOCATION_CODE)
go
...
alter table CL_NEGO_INVOICE
   add constraint FK_RELATIONSHIP_441 foreign key (INVOICE_ID)
      references PM_INVOICE (INVOICE_ID)
go
...
alter table CL_NEGO_POLICY_ROLE
   add constraint FK_RELATIONSHIP_629 foreign key (SUB_MODULE_ID)
      references PM_SUB_MODULE (SUB_MODULE_ID)
go
...
alter table CL_NEGO_RECEIPT
   add constraint FK_RELATIONSHIP_642 foreign key (RECEIPT_ID)
      references PM_RECEIPT (RECEIPT_ID)
go
...
alter table CL_WAIVE
   add constraint FK_RELATIONSHIP_595 foreign key (INVOICE_ID)
      references PM_INVOICE (INVOICE_ID)
go

alter table CL_WAIVE
   add constraint FK_RELATIONSHIP_608 foreign key (PM_ADJ_DTL_ID)
      references PM_ADJ_DTL (REQ_DTL_ID)
go

alter table CL_WAIVE
   add constraint FK_RELATIONSHIP_609 foreign key (PM_BATCH_ADJ_DTL_ID)
      references PM_BATCH_ADJ_DTL (BATCH_DTL_ID)
go
...
alter table PM_AR_MOVEMENT
   add constraint FK_RELATIONSHIP_500 foreign key (COMPANY_ID)
      references PM_COMPANY (COMPANY_ID)
go

alter table PM_AR_MOVEMENT
   add constraint FK_RELATIONSHIP_501 foreign key (BA_NO)
      references CL_BA_INFO (BA_NO)
go

alter table PM_AR_MOVEMENT
   add constraint FK_RELATIONSHIP_502 foreign key (REF_TRANS_ID)
      references PM_INVOICE (INVOICE_ID)
go

alter table PM_INVOICE
   add constraint FK_RELATIONSHIP_273 foreign key (BA_NO)
      references CL_BA_INFO (BA_NO)
go
